...
namespace yazlab1_3.v._1.Data {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class kullaniciDataTable : global::System.Data.TypedTableBase<kullaniciRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public kullaniciRow AddkullaniciRow(int yetki, string username, string psw, int file_id) {
        ...
        public partial class kullaniciRow : global::System.Data.DataRow {
            ...
            public string psw {
                get {
                    return ((string)(this[this.tablekullanici.pswColumn]));
                }
                set {
                    this[this.tablekullanici.pswColumn] = value;
                }
            }
            ...
            public int file_id {
                get {
                    return ((int)(this[this.tablekullanici.file_idColumn]));
                }
                set {
                    this[this.tablekullanici.file_idColumn] = value;
                }
            }
...
namespace yazlab1_3.v._1.Data.DataSet1TableAdapters {
    ...
    public partial class kullaniciTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("id1", "id");
            tableMapping.ColumnMappings.Add("username1", "username");
            tableMapping.ColumnMappings.Add("psw1", "psw");
            tableMapping.ColumnMappings.Add("file_id1", "file_id");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.InsertCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `kullanici` (`username`, `psw`, `file_id`, `username`, `psw`, `file_i" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["webConnectionString2"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT *, kullanici.* FROM kullanici";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO pdf (`Name`, `Data`, `Ders_adı`, `donem`) VALUES (@Name, @Data, @Ders" +
                "_adı, @donem)";
            ...
            this._commandCollection[1].Parameters.Add(param);
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@Ders_adı";
            param.DbType = global::System.Data.DbType.String;
            param.MySqlDbType = global::MySql.Data.MySqlClient.MySqlDbType.VarChar;
            param.Size = 1024;
            param.IsNullable = true;
            param.SourceColumn = "Ders_adı";
            param.SourceVersion = global::System.Data.DataRowVersion.Current;
            this._commandCollection[1].Parameters.Add(param);
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            ...
            this._commandCollection[4].CommandText = "UPDATE kullanici SET username=@username, psw=@psw WHERE id=@id";
            ...
            this._commandCollection[5].CommandText = "Delete FROM web.kullanici Where id=@id";
        ...
        public virtual DataSet1.kullaniciDataTable AdminListesi() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1(DataSet1.kullaniciDataTable dataTable, string username, string psw) {
            ...
            if ((psw == null)) {
                ...
                this.Adapter.SelectCommand.Parameters[1].Value = ((string)(psw));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSet1.kullaniciDataTable Girisarama(string username, string psw) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
        ...
        public virtual int Insert(string p1, string p2, int p3, string p4, string p5, int p6) {
            if ((p1 == null)) {
        ...
        public virtual int EklePdf(string Name, byte[] Data, string Ders_adı, string donem) {
            ...
            if ((Ders_adı == null)) {
                ...
                command.Parameters[2].Value = ((string)(Ders_adı));
            }
            if ((donem == null)) {
                throw new global::System.ArgumentNullException("donem");
            }
            else {
                command.Parameters[3].Value = ((string)(donem));
            }
        ...
        public virtual int KullaaniciGuncelle(string username, string psw, int id) {
        ...
        public virtual int UpdateAll(DataSet1 dataSet) {
            ...
            try {
                ...
                if ((this._kullaniciTableAdapter != null)) {
                    ...
                    this._kullaniciTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(workConnection));
                    this._kullaniciTableAdapter.Transaction = ((global::MySql.Data.MySqlClient.MySqlTransaction)(workTransaction));
                ...
                if ((this._kullaniciTableAdapter != null)) {
                    this._kullaniciTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(revertConnections[this._kullaniciTableAdapter]));
